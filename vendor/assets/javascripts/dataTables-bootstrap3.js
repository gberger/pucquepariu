...
(function (factory) {
    ...
    /* Set the defaults for DataTab les initialisation */
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
				{
					...
					$(nPaging).append(
						'<ul class="pagination">'+
						'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'"><span class="fa fa-chevron-circle-left"></span>&nbsp;'+oLang.sFirst+'</a></li>'+
						...
						'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'">'+oLang.sLast+'&nbsp;<span class="fa fa-chevron-circle-right"></span></a></li>'+
						'</ul>'
					);
					var els = $('a', nPaging);
					var nFirst = els[0],
